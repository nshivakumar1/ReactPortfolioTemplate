...
[Linkedin](https://linkedin.com/in/nakulshivakumar) | nakulshivakumar84@gmail.com

Or, use this repo and post an "issue" :)

All that I ask is that you please credit [Twitter]https://www.x.com/paytonpiercedev for the template :) If you'd like to remove the credit from the bottom of
the site, go for it, just link the creator's profile somewhere in your ReadMe when you deploy, or wherever.

.•° ✿ °•.

If you enjoyed this template and want to support the creator's ability to make more of these,
